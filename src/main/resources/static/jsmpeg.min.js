        ...
        if(num > 3) {
            ...
            if(faces != null && faces.length > 0){
                for (let i = 0; i < faces.length; i++) {
                    let face = faces[i];
                    //在圈人脸之前截图
                    syncFace2(face,this.imageData)
                }
                /*圈出人脸*/
                for (let i = 0; i < faces.length; i++) {
                    let face = faces[i];
                    var img = $('<img src="face.png">');
                    $(img).css("position","absolute");
                    $(img).css("left",+face['x']+"px");
                    $(img).css("top",+face['y']+"px");
                    $(img).css("width",face['w']+"px");
                    $(img).css("height",face['h']+"px");
