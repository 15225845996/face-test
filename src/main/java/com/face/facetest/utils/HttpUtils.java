...
import com.face.facetest.controller.FaceController;
...
/*map.put("access_token","24.97b32f07e3897d344883fbe1b8e9a30e.2592000.1595058903.282335-11562283");*//*
        ...
        //保存日志
        FileUtils.appendToFile("C:\\FFOutput\\item-"+sdf.format(new Date())+".log",sdf1.format(new Date())+"]"+result);
        return jsonObject;
    }
